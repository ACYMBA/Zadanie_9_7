...
var newGameElem = document.getElementById('js-newGameElement'),
    ...
    endResultsElem = document.getElementById('js-endResult');
...
function setGameElements() {
  switch(gameState) {
    ...
    case 'ended':
        ...
        endResultsElem.innerText = 'TU BĘDZIE OGŁOSZONY ZWYCIĘZCA';
    case 'notStarted':
    default:
  ...
  var winnerIs = 'player';
    ...
    if (winnerIs == 'player') {
        ...
        if ( playerPointsElem.innerHTML == 10){
          endResultsElem.innerHTML = ('WIN ' + player.name);    
          gameState = 'ended';
          setGameElements();
        }
        ...
        if ( computerPointsElem.innerHTML == 10){
          endResultsElem.innerHTML = ('WIN Computer');
          gameState = 'ended';
          setGameElements();
        }
    } else {
